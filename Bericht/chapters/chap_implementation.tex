...
QUARC-Echtzeitkern, wartet jedoch in dieser Ausbaustufe noch nicht auf eine
Rückmeldung des \ac{krl}-Programms auf der Steuerung (Pollen); die
entsprechende Erweiterung war zum Zeitpunkt dieser Messung noch nicht
abgeschlossen. Gemessen wurde daher zunächst nur, ob QUARC seinen eigenen
Modelltakt von \SI{100}{\milli\second} während der Laufzeit einhält; analog
zur Baseline-Messung wurden dazu 5 identische Messläufe durchgeführt
