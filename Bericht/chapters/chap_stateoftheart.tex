...
Von den beiden bereitgestellten Modellen enthält nur die Variante mit
Smith-Kompensation die entsprechenden Zusatzblöcke (u.\,a.\ ein
Unit-Delay-Element zur diskreten Totzeitmodellierung sowie eine
Plausibilitätsprüfung des rohen Sensorsignals). In der finalen
Modellversion wurde die Smith-Kompensation wieder entfernt; die
Regelungsergebnisse beider Varianten werden im Rahmen der
Reglerparametrierung in Kapitel~\ref{sec:implementierung} verglichen.
