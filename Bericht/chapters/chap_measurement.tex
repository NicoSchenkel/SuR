...
anschließend eine reduzierte Wartezeit von 20 Ticks getestet, wobei im
durchgeführten Versuch kein instabiles Verhalten auftrat. Bei einer weiteren
Reduktion auf 10 Ticks kam es dagegen zu starken Schwingungen, sodass der
Versuch aus Sicherheitsgründen abgebrochen wurde.
Abbildung~\ref{fig:smith_20ticks} zeigt den Signalverlauf des stabilen
Versuchs mit 20 Ticks.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.72\linewidth]{images/smith_20ticks.png}
    \caption{Regelungsverhalten mit aktivierter Smith-Kompensation bei
    einer Wartezeit von 20 Ticks zwischen den Positionsaktualisierungen.}
...
des Gesamtsystems durch die Smith-Kompensation ableiten. Im durchgeführten
Versuch blieb das System mit aktivierter Smith-Kompensation bei einer
Wartezeit von 20 Ticks stabil. Die Smith-Kompensation wurde nicht in die
final verwendete Regelungsversion übernommen.